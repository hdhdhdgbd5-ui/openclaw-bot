"""
Quick Cloudflare Bypass Test - Groq
Test bypassing Cloudflare on Groq
"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("Cloudflare Bypass - Groq Test")
    print("=" * 60)
    ...
    if content and len(content) > 1000:
        ...
        if 'groq' in content_lower:
            print("[+] Confirmed: This is Groq!")
            # Try to find some content
            if 'API' in content or 'LLM' in content or 'AI' in content:
                print("[+] Found AI/API content")
    else:
